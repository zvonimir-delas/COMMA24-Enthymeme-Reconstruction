...
def run_module(arg_scheme_label, dataset_path, local_model_path, existing_run_id=None):
    ...
    with open(f'{outputs_path}/metrics/stage-2-scheme-{arg_scheme_label}-dev-metrics', "w") as file:
...
if __name__ == "__main__":
    ...
    existing_run_id = sys.argv[4] if len(sys.argv) > 4 else None

    run_module(arg_scheme_label, dataset_path, model_path, existing_run_id)
