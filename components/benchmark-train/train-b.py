...
def run_module(dataset_path, run_id):
    ...
    model_output_dir = f'{outputs_path}/models/'
    ...
    with open(f'{outputs_path}/logs/training-log', 'w') as f:
...
# python modules/benchmark-train/train-b.py modules/benchmark-combine-pairs/outputs/benchmark_1/data/combined-pairs-from-all-schemes.json benchmark_1
